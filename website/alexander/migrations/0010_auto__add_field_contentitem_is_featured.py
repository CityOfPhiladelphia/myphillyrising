...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContentItem.is_featured'
        db.add_column(u'alexander_contentitem', 'is_featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContentItem.is_featured'
        db.delete_column(u'alexander_contentitem', 'is_featured')
