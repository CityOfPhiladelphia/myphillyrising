...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ContentItem.source_posted_at'
        db.delete_column(u'alexander_contentitem', 'source_posted_at')


    def backwards(self, orm):
        # Adding field 'ContentItem.source_posted_at'
        db.add_column(u'alexander_contentitem', 'source_posted_at',
