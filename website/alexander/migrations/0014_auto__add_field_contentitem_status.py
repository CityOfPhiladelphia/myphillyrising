...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContentItem.status'
        db.add_column(u'alexander_contentitem', 'status',
                      self.gf('django.db.models.fields.CharField')(default='pending', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContentItem.status'
        db.delete_column(u'alexander_contentitem', 'status')
