...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContentItem.address'
        db.add_column(u'alexander_contentitem', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContentItem.address'
        db.delete_column(u'alexander_contentitem', 'address')
