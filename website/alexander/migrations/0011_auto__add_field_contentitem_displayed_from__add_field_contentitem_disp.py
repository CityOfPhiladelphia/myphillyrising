...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContentItem.displayed_from'
        db.add_column(u'alexander_contentitem', 'displayed_from',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 23, 0, 0)),
                      keep_default=False)

        # Adding field 'ContentItem.displayed_until'
        db.add_column(u'alexander_contentitem', 'displayed_until',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContentItem.displayed_from'
        db.delete_column(u'alexander_contentitem', 'displayed_from')

        # Deleting field 'ContentItem.displayed_until'
        db.delete_column(u'alexander_contentitem', 'displayed_until')
