...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'myphillyrising_userprofile', u'id')


        # Changing field 'UserProfile.user'
        db.alter_column(u'myphillyrising_userprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, primary_key=True, to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProfile.user'
        db.alter_column(u'myphillyrising_userprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
