...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAction.awarded_at'
        db.add_column(u'myphillyrising_useraction', 'awarded_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 8, 8, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAction.awarded_at'
        db.delete_column(u'myphillyrising_useraction', 'awarded_at')
    ...
    models = {
        ...
        u'myphillyrising.useraction': {
            ...
            'awarded_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
