...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'myphillyrising_useraction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='actions', to=orm['myphillyrising.UserProfile'])),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='actions', null=True, to=orm['alexander.ContentItem'])),
            ('points', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal(u'myphillyrising', ['UserAction'])


    def backwards(self, orm):
        # Deleting model 'UserAction'
        db.delete_table(u'myphillyrising_useraction')
    ...
    models = {
        ...
        u'myphillyrising.useraction': {
            ...
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'actions'", 'to': u"orm['myphillyrising.UserProfile']"}),
