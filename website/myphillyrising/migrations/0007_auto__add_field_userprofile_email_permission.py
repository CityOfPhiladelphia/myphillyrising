...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.email_permission'
        db.add_column(u'myphillyrising_userprofile', 'email_permission',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.email_permission'
        db.delete_column(u'myphillyrising_userprofile', 'email_permission')
