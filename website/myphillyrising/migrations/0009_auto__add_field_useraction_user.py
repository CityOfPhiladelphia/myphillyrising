...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAction.user'
        db.add_column(u'myphillyrising_useraction', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='actions', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAction.user'
        db.delete_column(u'myphillyrising_useraction', 'user_id')
    ...
    models = {
        ...
        u'myphillyrising.useraction': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'actions'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
